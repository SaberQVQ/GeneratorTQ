...
public class DTOTask extends AbstractTask {
    ...
    public DTOTask(String className) {
        super(className);
    }
    ...
    public DTOTask(String tableName, String className, String parentTableName, String parentClassName, String foreignKey, String parentForeignKey, String relationalTableName, List<ColumnInfo> tableInfos, List<ColumnInfo> parentTableInfos) {
